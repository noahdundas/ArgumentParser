#ifndef INT_ARGUMENT_HPP
#define INT_ARGUMENT_HPP
...
namespace Arguments
{
    /**
     * @class IntArgument
     * @brief This type of Argument is built to handle the int type.
     */
    ...
    public:
        /**
         * @brief Constructs a new IntArgument object.
         * 
         ...
         */
        IntArgument(const std::string &con_name, int con_value, bool con_required);
