#ifndef DOUBLE_ARGUMENT_HPP
#define DOUBLE_ARGUMENT_HPP
...
namespace Arguments
{
     ...
     * @brief This type of Argument is built to handle the double type.
     */
    ...
    public:
        /**
         * @brief Constructs a new DoubleArgument object.
         ...
         */
        DoubleArgument(const std::string &con_name, double con_value, bool con_required);
