#ifndef BOOL_ARGUMENT_HPP
#define BOOL_ARGUMENT_HPP
...
namespace Arguments
{
    ...
    public:
        /**
         * @brief Constructs a new BoolArgument object.
         * 
         ...
         */
        BoolArgument(const std::string &con_name, bool con_value, bool con_required);
